...
class LVISMaskRCNN(BaseDetector, BBoxTestMixin, MaskTestMixin):
    ...
    def init_weights(self, pretrained=None):
        super(LVISMaskRCNN, self).init_weights(pretrained)
    ...
    def forward_train(self,
        ...
        context_labels, label_weights = self.context_head.get_target(
            gt_labels, img_meta)
        context_loss = self.context_head.loss(context_preds, context_labels,
                                              label_weights)
